...
// RBAC permissions enum for project service
typedef enum {
    PERM_READ_PROJECTS,      // View projects
    PERM_CREATE_PROJECTS,    // Create new projects
    PERM_UPDATE_PROJECTS,    // Update existing projects
    PERM_DELETE_PROJECTS,    // Delete projects
    PERM_MANAGE_MEMBERS,     // Add/remove project members
    PERM_ADMIN_ONLY          // Admin-only operations
} Permission;
